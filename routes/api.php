...
Route::post('/borrarTarjeta', [MiCuentaController::class, 'borrarTarjeta']);
Route::post('/procesarReservaUnlogged', [FormularioController::class, 'procesarReservaUnlogged'])->middleware('auth:sanctum');
