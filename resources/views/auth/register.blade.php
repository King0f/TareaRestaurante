            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="alergias" class="col-md-4 col-form-label text-md-end">{{ __('Alergias') }}</label>

                            <div class="col-md-6">
                                <input id="alergias" type="text" class="form-control @error('alergias') is-invalid @enderror" name="alergias" value="{{ old('alergias') }}" autocomplete="alergias">
